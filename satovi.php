...
$sql = "SELECT * FROM proizvodi WHERE kategorija_id = 3 AND aktivan = 1";
...
proizvodi">
 ...
 <body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand" href="indeks.html"> <img src="./slike/logo.jpeg" alt="logo" width="110" ></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="indeks.html">Početna</a>
          </li>
          <li class="nav-item">
 ...
 <footer class="text-center text-lg-start bg-body-tertiary text-muted">
      ...
      <span id="info"  class="user-select-none"><i class="textfooter"><i class="fa-solid fa-circle-info"></i>Korisne informacije: </i><hr class="linija"></span>
       ...
       <div class="row mt-3" style="background-color: rgb(238,221,203)  ;">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
         <a href="index.html"> <img src="slike/logo.jpeg" class="rounded mx-auto d-block" alt="logo" style="max-width: 150px;"> </a>
        </div>
  ...
  <div class="text-center p-4 user-select-none" style="background-color: rgb(183,110,121)">
    <a href="index.html"  class="kopi">KORAL</a> 
