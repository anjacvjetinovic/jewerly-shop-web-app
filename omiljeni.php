...
proizvodi">
 ...
 <body>
  ...
  <br>
   <section>
    <div class="container">
      <h2 class="display-4" style="text-align: center;">Omiljeni proizvodi</h2>
    <hr>
    <div class="row">

    <a href="obrisi_omiljene.php" class="btn btn-danger mb-3">
    Obriši sve omiljene
</a>

              <!--dodavanje proizvoda u omiljeni-->
<?php
if(!isset($_SESSION['omiljeni']) || empty($_SESSION['omiljeni'])){
    echo "Nemate omiljenih proizvoda.";
    exit();
}

$ids = implode(",", $_SESSION['omiljeni']);
$sql = "SELECT * FROM proizvodi WHERE id IN ($ids) AND aktivan = 1";
